...
//        self.navigationItem.title = "职位状态"
    ...
    lazy var tableView: UITableView = {
        let tableView = UITableView(frame: CGRect(x: 0, y: 0, width: DLScreenWidth, height: DLScreenHeight - DLTabBarHeight - DLnavigationBarHeight - DLStatusBarHeight - DLStripBarButtonHeight), style: UITableViewStyle.grouped)
